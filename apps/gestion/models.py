...
class AsignacionActividad(models.Model):
    ...
    entregable = models.FileField(upload_to="entregables/", blank=True, null=True, help_text="Archivo entregable del ejecutor")
    ...
    revision_entregable = models.FileField(upload_to="entregables_revision/", blank=True, null=True, help_text="Archivo entregable del revisor")
