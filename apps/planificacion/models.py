...
class PlanificacionDetalle(models.Model):
    ...
    fecha_programada = models.DateTimeField(null=True, blank=True, help_text="Fecha en que aparece en el tablero del usuario")
    fecha_vencimiento = models.DateTimeField(null=True, blank=True, help_text="Fecha limite o deadline de la actividad")
    activo = models.BooleanField(default=True)
    fecha_creacion = models.DateTimeField(auto_now_add=True)
    fecha_update = models.DateTimeField(auto_now=True)
